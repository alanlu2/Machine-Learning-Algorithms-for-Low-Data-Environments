'''
THIS STUDY LOOKS AT USING A VARIABLE TRAIN DATASET TO OPTIMIZE CLASSIFICATION ACCURACY ON FASHION_MNIST.  UNBALANCED, NEIL'S MODEL
'''
...
for iteration in range(total_iterations):
    ...
    filepath='snnbestweights_v6.hdf5'
    callbacks = [
    ...
    np.savetxt("snn_network_accuracies_s2_v6_unbalanced"+str(iteration)+".csv",scores,delimiter=",")
...
np.savetxt("snn_network_accuracies_s2_unbalanced.csv",overall_siamese,delimiter=",")
np.savetxt("snn_testing_accuracies_s2_unbalanced.csv",overall_testing,delimiter=",")
